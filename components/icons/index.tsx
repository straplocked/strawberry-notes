...
export const IconPin = (p: IconProps) => (
  <svg {...common(p)}>
    <path d="M15 3 21 9M10 14l-6.5 6.5M13.5 6.5l4 4M8.5 12.5l3-3 3 3 3-3-4-4-3 3-3 3 4 4z" />
  </svg>
);
...
export const IconPinFill = (p: IconProps) => {
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M14.6 3.4a1 1 0 0 1 1.4 0l4.6 4.6a1 1 0 0 1 0 1.4l-2.5 2.5-3.3-1.2-3.7 3.7 1.2 3.3-.7.7-4.6-4.6-1.5 1.5-.7-.7 1.5-1.5-4.6-4.6.7-.7 3.3 1.2 3.7-3.7-1.2-3.3L14.6 3.4z" />
    </svg>
  );
};
